          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-[12px] text-gray-600">
                Select an item from the right sidebar to preview and download PDF.
              </p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 rounded-full bg-black px-3 py-2 text-[11px] font-medium text-white hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
              >
                <Download size={13} />
                Download PDF
              </button>
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[1fr_330px]">
          <main className="rounded-2xl border border-gray-200 bg-white p-3 sm:p-5">
            {!selectedItem || (isLedScreen() && !selectedLedRow) ? (
              ...
              <div id="report-preview" className="w-full">
